...
board: FRDM-K32L2B
pin_labels:
- {pin_num: '23', pin_signal: PTA1/LPUART0_RX/TPM2_CH0, label: UART0_RX, identifier: DEBUG_UART0_RX}
- {pin_num: '24', pin_signal: PTA2/LPUART0_TX/TPM2_CH1, label: UART0_TX, identifier: DEBUG_UART0_TX}
